                            ...
                            try {
                                if(isUnix() == true) {
                                    sh """
                                        ...
                                        java -jar veracode_scanner/pipeline-scan.jar --veracode_api_id $VERACODE_API_ID --veracode_api_key $VERACODE_API_KEY --file app/target/verademo.war --issue_details true -bf baseline_results.json
                                        """
                                }
                                else {
                                    powershell """
                                            ...
                                            java -jar pipeline-scan.jar --veracode_api_id $VERACODE_API_ID --veracode_api_key $VERACODE_API_KEY --file app/target/verademo.war --issue_details true -bf powershell-baseline.json
                                            """
                                }
                            } catch (err) {
